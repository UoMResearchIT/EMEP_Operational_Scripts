...
### EMEP specific attributes (make setting these more interactive later?)

EMEP_Att = {}
EMEP_Att['country_ISO'] = 'GB'
EMEP_Att['units']       = 'mg/m2/year'
EMEP_Att['factor']      = 1.0e3
EMEP_Att['oldunits']    = 'tonnes/km^2/year'

EMEP_sect_map = {}
EMEP_sect_map['energyprod'] = 1
EMEP_sect_map['domcom']     = 2
EMEP_sect_map['indcom']     = 3
EMEP_sect_map['indproc']    = 4
